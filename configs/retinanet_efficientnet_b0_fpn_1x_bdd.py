...
log_level = 'INFO'
work_dir = './work_dirs/retinanet_efficientnet_b0_fpn_1x_bdd_no_upsample_squeeze'
load_from = None
resume_from =None
# resume_from ='./work_dirs/retinanet_efficientnet_b0_fpn_1x_bdd_no_upsample_squeeze/latest.pth'
workflow = [('train', 1)]
